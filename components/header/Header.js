      ...
      subMenu: [
        {
          ...
          link: "/",
          subMenu: [
            { label: "About CSE", link: "/departments/Computer-Science/about/" },
            { label: "Vision & Mission", link: "/departments/Computer-Science/VisionAndMission/" },
            { label: "Course Outcomes", link: "/departments/Computer-Science/CourseOutcomes/" },
            { label: "Program Outcomes", link: "/departments/Computer-Science/ProgramOutcomes/" },
            { label: "Program Specific Outcomes", link: "/departments/Computer-Science/ProgramSpecificOutcomes/" },
            { label: "Program Educational Objectives", link: "/departments/Computer-Science/programEducationalOutcomes/" },
          ],
        },
        {
          ...
          subMenu: [
            ...
            { label: "Vision & Mission", link: "/departments/mechanical/vissionMission" },
            { label: "Course Outcomes", link: "/departments/mechanical/courseOutcome" },
            { label: "Program Outcomes", link: "/departments/mechanical/programOutcome" },
            { label: "Program Specific Outcomes", link: "/departments/mechanical/programSpecificOutcome" },
            { label: "Program Educational Objectives", link: "/departments/mechanical/programEducationalObjective" },
            { label: "News Letters and Magazines-ME", link: "/departments/mechanical/newsLetter" },
            { label: "Teaching-Learning ME", link: "/departments/mechanical/training" },
          ],
        },
        {
          ...
          link: "/",
          subMenu: [
            { label: "About ECE", link: "/departments/ElectronicsAndCommunication/about" },
            { label: "Vision & Mission", link: "/departments/ElectronicsAndCommunication/VisionAndMission/" },
            { label: "Course Outcomes", link: "/departments/ElectronicsAndCommunication/CourseOutcomes/" },
            { label: "Program Outcomes", link: "/departments/ElectronicsAndCommunication/ProgramOutcomes/" },
            { label: "Program Educational Objectives", link: "/departments/ElectronicsAndCommunication/programEducationalOutcomes/" },
            { label: "Program Specific Outcomes", link: "/departments/ElectronicsAndCommunication/ProgramSpecificOutcomes" },
          ],
        },
        {
          ...
          subMenu: [
            ...
            { label: "Vision & Mission", link: "/departments/electrical/vissionMission" },
            { label: "Course Outcomes", link: "/departments/electrical/courseOutcome" },
            { label: "Program Outcomes", link: "/departments/electrical/programOutcome" },
            { label: "Patents", link: "/departments/electrical/patents" },
            { label: "Program Specific Outcomes", link: "/departments/electrical/programSpecificOutcome" },
            { label: "Program Educational Objectives", link: "/departments/electrical/programEducationObjective" },
          ],
        },
        
        {
          ...
          subMenu: [
            ...
            { label: "Vision & Mission", link: "/departments/Civil/VisionAndMission" },
            { label: "Course Outcomes", link: "/departments/Civil/CourseOutcomes" },
            { label: "Program Outcomes", link: "/departments/Civil/ProgramOutcomes" },
            { label: "Program Specific Outcomes", link: "/departments/Civil/ProgramSpecificOutcomes" },
            { label: "Program Educational Objectives", link: "/departments/Civil/programEducationalOutcomes" },
          ],
        },
        {
          label: "Management",
          link: "/",
          subMenu: [
            { label: "About", link: "/departments/management/aboutm" },
            { label: "Vision & Mission", link: "/departments/management/vissionMission" },
        ...
        },
        {
          ...
          link: "/",
          subMenu: [
            { label: "About CA", link: "/departments/computer/aboutc" },
            { label: "Vision & Mission", link: "/departments/computer/vissionMission" },
            { label: "Course Outcomes", link: "/" },
            { label: "Program Outcomes", link: "/" },
            { label: "Program Educational Objectives", link: "/" },
            { label: "Program Specific Outcomes", link: "/" },
