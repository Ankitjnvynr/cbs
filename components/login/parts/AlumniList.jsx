...
export default function AlumniList({ rows, currentPage, getAlumniResponse }) {
  ...
  const handleDelete = async () => {
    if (selectedId) {
      const response = await alumniService.deleteRecord(selectedId);
  ...
  const handleEditSave = async () => {
    if (selectedId) {
      ...
      const response = await alumniService.updateRecord(selectedId, editData);
