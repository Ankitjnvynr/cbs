...
const WhatsAppChat = () => {
    ...
    return (
        ...
        >
            ...
            >
                <FontAwesomeIcon icon={faWhatsapp} style={{ marginLeft: '10px', color: '#25D366', fontSize: 35 }} />
            </div>

            {/* WhatsApp Chat Box */}
            {isOpen && (
                <div style={{zIndex:200}} className="fixed bottom-20 right-5 bg-white shadow-lg rounded-lg w-72">
