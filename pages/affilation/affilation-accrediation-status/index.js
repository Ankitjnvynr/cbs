...
import AffiliationAccreditationstatus from '../../../components/affilation/AffiliationAccreditationstatus';
...
function group() {
  return (
    ...
    <PageTitle pageTitle={'Affiliation & Accreditation status'} pagesub={'vision'} />
     <AffiliationAccreditationstatus/>
    <Footer />
    <Scrollbar />
    <CursorMaus />
</Fragment>
